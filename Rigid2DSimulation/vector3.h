...
struct vector3 {
	...
	vector3 unit() const { return zero() ? vector3{} : *this / len(); }
...
struct mat3 {
	...
	mat3(vector3 v0, vector3 v1, vector3 v2) : mat3(
		v0.x, v1.x, v2.x,
		v0.y, v1.y, v2.y,
		v0.z, v1.z, v2.z) {}
	...
	static mat3 tensor(vector3 a, vector3 b) {
		return mat3(b.x * a, b.y * a, b.z * a);
	}
	static mat3 rot(vector3 a, double theta) {
		// 这里假设了 a 是单位的。
		mat3 mz = tensor(a, a);
	...
	vector3 v0() const { return { a00, a10, a20 }; }
	vector3 v1() const { return { a01, a11, a21 }; }
	vector3 v2() const { return { a02, a12, a22 }; }
...
inline vector3 operator*(mat3 const& a, vector3 b) {
	return {
