...
{
	return generateRadomInt(0, sz - 1);
}

double generateRadomFloat(double lowerBound, double upperBound)
{
...
double generateRadomFloat(double upperBound)
{
	return generateRadomFloat(0, upperBound);
}
